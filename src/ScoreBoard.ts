import { EventType, type GoalPayload, type MatchEndPayload, type MatchEventPayload, type MatchObserver, type ScoreDisplayPayload } from "./MatchEvents.js";

export class ScoreBoard implements MatchObserver{

    public onEvent( type : EventType, payload : MatchEventPayload) : void {
